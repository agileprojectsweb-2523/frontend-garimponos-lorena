    ...
    <>
      <header className={styles.header}>
        ...
        <div className={styles.actions}>
          ...
          {/* ÍCONES DESKTOP (VÃO SUMIR NO MOBILE VIA CSS) */}
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className={styles.mobileHeader}>
              <span className={styles.mobileLogo}>Garimpo<span>.Nós</span></span>
              <button onClick={() => setMobileMenuOpen(false)} className={styles.closeMenuBtn}>✕</button>
            </div>

            {/* ÍCONES EXTRAS MOVIDOS PARA DENTRO DO MENU */}
